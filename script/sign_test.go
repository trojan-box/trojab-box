...
func TestSignLogin(t *testing.T) {
	...
	address := "0x7c7A5e0A0A691D8913A24EDC6A367D24D93831dD"
	privateKeyStr := "d425ba17713cc45e13d201f0fbc4ec0adb3fcfcb4188be044e285eb6281a8cd3"
	nonce := "69128213"
	timestamp := "1645768781"

	msg := strings.ReplaceAll(constant.LoginSignMsg, "${address}", address)
	...
	fmt.Println("signature msg", hexutil.Encode(signature))
	...
	verified := crypto.VerifySignature(publicKeyBytes, msgHash.Bytes(), signatureNoRecoverID)
	fmt.Println(verified) // true

}

func TestSignPlayGame(t *testing.T) {
	//0x9866c5dB69592ade1F1179D5110fDc7Be46F6f25,ae62e62adb70f4684bf9cc463eb4b4c5dab932da959e71f2a0c09c3ac5488c8b
	//0x92561002B6BB157B7839E05953094cF47d8c7B61,954b3d334bcb0447018c33f00665a4f0ca7241b6e991e8107e4ef32f6f13a780
	//0x7c7A5e0A0A691D8913A24EDC6A367D24D93831dD,d425ba17713cc45e13d201f0fbc4ec0adb3fcfcb4188be044e285eb6281a8cd3
	//0x1170e45A16fdf7410beb68C913DF94c647366e09,4a18fbefa70befdb5b6aee6a2861fd438d77558c5e753293f5e6e4320024fc94
	...
	privateKeyStr := "ae62e62adb70f4684bf9cc463eb4b4c5dab932da959e71f2a0c09c3ac5488c8b"
	nonce := "76951248"
	timestamp := "1642734875"
...
func TestSignWithdrawApply(t *testing.T) {
	//0x9866c5dB69592ade1F1179D5110fDc7Be46F6f25,ae62e62adb70f4684bf9cc463eb4b4c5dab932da959e71f2a0c09c3ac5488c8b
	//0x92561002B6BB157B7839E05953094cF47d8c7B61,954b3d334bcb0447018c33f00665a4f0ca7241b6e991e8107e4ef32f6f13a780
	//0x7c7A5e0A0A691D8913A24EDC6A367D24D93831dD,d425ba17713cc45e13d201f0fbc4ec0adb3fcfcb4188be044e285eb6281a8cd3
	//0x1170e45A16fdf7410beb68C913DF94c647366e09,4a18fbefa70befdb5b6aee6a2861fd438d77558c5e753293f5e6e4320024fc94
	...
	address := "0x92561002B6BB157B7839E05953094cF47d8c7B61"
	privateKeyStr := "954b3d334bcb0447018c33f00665a4f0ca7241b6e991e8107e4ef32f6f13a780"
	nonce := "94720666"
	timestamp := "1645687906"
	bonus := "100"

	msg := strings.ReplaceAll(constant.WithdrawBonusApplySignMsg, "${address}", address)
	msg = strings.ReplaceAll(msg, "${nonce}", nonce)
	msg = strings.ReplaceAll(msg, "${timestamp}", timestamp)
	msg = strings.ReplaceAll(msg, "${bonus}", bonus)
